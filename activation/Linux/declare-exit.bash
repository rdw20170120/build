...
# 130    script terminated by Control-C (130 = 128 + 2)
...
# system programs, notably delivermail and the Berkeley network.
#
...
#   message when something you wanted to do doesn't work, but you don't know
#   why.
...
#   be used for such things as "cannot fork", "cannot create pipe", or the
#   like.  It includes things like getuid returning a user that does not exist
#   in the passwd file.
# EX_OSFILE -- Some system file (e.g., /etc/passwd, /etc/utmp, etc.) does not
