...
def copy_starter_files():
    return [
        ...
        eol(),
        line(),
        assign(vn("FileTgt"), path(vr("DirTgt"), "project-fix-permissions.bash")),
        eol(),
        comment("Move previous scripts to new path"),
        file_exists(path(vr("DirTgt"), "all-fix-permissions.bash")),
        and_(),
        command("mv", path(vr("DirTgt"), "all-fix-permissions.bash"), vr("FileTgt")),
        eol(),
        comment("Copy starter script, if necessary"),
        path_is_not_file(vr("FileTgt")),
        and_(),
        command(
            "cp", path(vr("DirSrc"), "project-fix-permissions.bash"), vr("FileTgt")
        ),
        eol(),
        line(),
        ...
        path_is_not_file(vr("FileTgt")),
        and_(),
        command("cp", path(vr("DirSrc"), "project-declare.src"), vr("FileTgt")),
        eol(),
        line(),
        ...
        path_is_not_file(vr("FileTgt")),
        and_(),
        command("cp", path(vr("DirSrc"), "project-development.rst"), vr("FileTgt")),
        eol(),
        line(),
        ...
        path_is_not_file(vr("FileTgt")),
        and_(),
        command("cp", path(vr("DirSrc"), "project-declare-BASH.src"), vr("FileTgt")),
        eol(),
        line("DisabledContent"),
    ]
...
def create_random_tmpdir():
    return [
        ...
        assign(vn("Dir"), substitute("mktemp", "--tmpdir", "-d", "BO-XXXXXXXX")),
        eol(),
...
def declare_for_bootstrap():
    return [
        ...
        line(),
        assign(vn("Script"), dq(path(vr("BO_Project"), "BriteOnyx", "declare.src"))),
        eol(),
...
def initialize_logging_file():
    return [
        ...
        eol(),
        echo_warn("This script MUST be executed as 'source activate.src', WAS IT?"),
        eol(),
    ]
...
def normalize_reference_to_project_root():
    return [
        ...
        eol(),
        export(vn("BO_Project"), dq(substitute("boNodeCanonical", vr("BO_Project")))),
        eol(),
        trace_variable(sq(vn("BO_Project"))),
        eol(),
        bo_log_info(
...
def remember_path():
    return [
        ...
        nl(),
        "  ",
        echo_info("Remembering ", vn("BO_PathSystem"), "=", sq(vr("BO_PathSystem"))),
        eol(),
    ]
