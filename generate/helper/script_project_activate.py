...
def copy_starter_files():
    return [
        ...
        line(),
        assign('FileTgt', pathname(vr('DirTgt'), '.BriteOnyx.src')), eol(),
        comment('Move previous scripts to new path'),
        file_exists(pathname(vr('DirTgt'), 'BriteOnyx.src')), and_(),
        command('mv', [pathname(vr('DirTgt'), 'BriteOnyx.src'), '$FileTgt']), eol(),
        file_exists(pathname(vr('DirTgt'), 'BriteOnyx-env.bash')), and_(),
        command('mv', [pathname(vr('DirTgt'), 'BriteOnyx-env.bash'), '$FileTgt']), eol(),
        file_exists(pathname(vr('DirTgt'), 'BriteOnyx-env.src')), and_(),
        command('mv', [pathname(vr('DirTgt'), 'BriteOnyx-env.src'),  '$FileTgt']), eol(),
        comment('Copy starter script, if necessary'),
        path_is_not_file('$FileTgt'), and_(),
        command('cp', [pathname(vr('DirSrc'), 'user-BriteOnyx.src'), '$FileTgt']), eol(),
        line(),
        assign(vn('DirTgt'), pathname(vr('BO_Project'))), eol(),
        path_does_not_exist(vr('DirTgt')), and_(),
        command('mkdir', ['-p', vr('DirTgt')]), eol(),
        line(),
        assign('FileTgt', pathname(vr('DirTgt'), 'env.src')), eol(),
        path_is_not_file('$FileTgt'), and_(),
        command('cp', [pathname(vr('DirSrc'), 'project-env.src'), '$FileTgt']), eol(),
        line(),
        assign('FileTgt', pathname(vr('DirTgt'), '.hgignore')), eol(),
        path_is_not_file('$FileTgt'), and_(),
        command('cp', [pathname(vr('DirSrc'), 'project.hgignore'), '$FileTgt']), eol(),
        line(),
        assign(vn('DirTgt'), pathname(vr('BO_Project'), 'bin')), eol(),
        path_does_not_exist(vr('DirTgt')), and_(),
        command('mkdir', ['-p', vr('DirTgt')]), eol(),
        line(),
        assign('FileTgt', pathname(vr('DirTgt'), 'project-fix-permissions.bash')), eol(),
        comment('Move previous scripts to new path'),
        file_exists(pathname(vr('DirTgt'), 'all-fix-permissions.bash')), and_(),
        command('mv', [pathname(vr('DirTgt'), 'all-fix-permissions.bash'), '$FileTgt']), eol(),
        comment('Copy starter script, if necessary'),
        path_is_not_file('$FileTgt'), and_(),
        command('cp', [pathname(vr('DirSrc'), 'project-fix-permissions.bash'), '$FileTgt']), eol(),
        line(),
        line(": <<'DisabledContent'"),
        assign('FileTgt', pathname(vr('DirTgt'), 'declare.src')), eol(),
        path_is_not_file('$FileTgt'), and_(),
        command('cp', [pathname(vr('DirSrc'), 'project-declare.src'), '$FileTgt']), eol(),
        line(),
        assign('FileTgt', pathname(vr('DirTgt'), 'development.rst')), eol(),
        path_is_not_file('$FileTgt'), and_(),
        command('cp', [pathname(vr('DirSrc'), 'project-development.rst'), '$FileTgt']), eol(),
        line(),
        assign('FileTgt', pathname(vr('DirTgt'), 'README.rst')), eol(),
        path_is_not_file('$FileTgt'), and_(),
        command('cp', [pathname(vr('DirSrc'), 'project-README.rst'), '$FileTgt']), eol(),
        line(),
        assign(vn('DirTgt'), pathname(vr('BO_Project'), 'bin/helper/Linux')), eol(),
        path_does_not_exist(vr('DirTgt')), and_(),
        command('mkdir', ['-p', vr('DirTgt')]), eol(),
        line(),
        assign('FileTgt', pathname(vr('DirTgt'), 'declare-BASH.src')), eol(),
        path_is_not_file('$FileTgt'), and_(),
        command('cp', [pathname(vr('DirSrc'), 'project-declare-BASH.src'), '$FileTgt']), eol(),
        line('DisabledContent'),
    ]
